...
import {
  ...
  Building2, Microscope, Wallet, Gift, Globe, BarChart3,
  Settings, FileQuestion, Wrench, Newspaper, Shield,
  FlaskConical, ChevronLeft, ChevronRight, Bell, Menu,
} from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="flex items-center gap-2">
            <Link href="/" className="text-sm text-gray-500 hover:text-gray-700 mr-2">
              返回前台
            </Link>
